"""Synthetic / AI-generated speech detector plugin."""
...
class SyntheticAudioDetector(AudioAIDetector):
    """Detect AI-generated or synthetic speech when a model is configured."""
    ...
    def metadata(self) -> AudioDetectorMetadata:
        return AudioDetectorMetadata(
            ...
            description="Detects AI-generated or synthetic speech.",
            supported_tasks=("synthetic_audio_detection",),
    ...
    async def predict(self, context: AudioAnalysisContext) -> AudioDetectorOutput:
        ...
        if not self._model_available:
            finding = unavailable_finding(
                detector=self.name,
                category=AudioFindingCategory.SYNTHETIC_AUDIO,
